...
export default function Home() {
  ...
  const onStart = () => {
    setDragState((cur) => ({ activeDrags: ++cur.activeDrags }));
  };
  ...
  const { speak } = useContext(AvatarContext);
  ...
  return (
    <div className="min-h-[100vh] w-full bg-[#000] md:overflow-auto overflow-hidden bdm">
      <Head>
        <title>LPU AI</title>
      </Head>
